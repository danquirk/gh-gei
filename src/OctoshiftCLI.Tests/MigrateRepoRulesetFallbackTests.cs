...
public class MigrateRepoRulesetFallbackTests
{
    [Fact]
    public async Task Warns_And_Continues_On_Ruleset_Api_Failure()
    {
        ...
        githubApi.Setup(g => g.GetRepoRulesets("ghorg", "repo")).ThrowsAsync(new OctoshiftCliException("404 Not Found"));
        ...
        log.Verify(l => l.LogWarning(It.Is<string>(s => s.Contains("Ruleset API unavailable"))), Times.Once);
    }
}
